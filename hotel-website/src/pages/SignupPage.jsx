...
const SignupPage = () => {
  return (
    <div className="signup-page" style={{padding: '48px 0', minHeight: '60vh', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
      <div style={{background: '#fff', borderRadius: '8px', boxShadow: '0 4px 16px rgba(0,0,0,0.08)', padding: '32px', maxWidth: '400px', width: '100%'}}>
        <h2 style={{marginBottom: '24px', color: 'var(--army-blue)'}}>Sign Up</h2>
        <form>
          <div style={{marginBottom: '16px'}}>
            <label htmlFor="name">Name</label>
            <input type="text" id="name" name="name" required style={{width: '100%', padding: '10px', borderRadius: '4px', border: '1px solid #ccc'}} />
          </div>
          <div style={{marginBottom: '16px'}}>
